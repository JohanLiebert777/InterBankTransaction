...
@Entity
@Table(name = "BANK_A_USER_HISTORICAL_OPERATION")
public class BankAUserHistoricalOperation implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BankAUserHistoricalOperation other = (BankAUserHistoricalOperation) obj;
		if (amount == null) {
