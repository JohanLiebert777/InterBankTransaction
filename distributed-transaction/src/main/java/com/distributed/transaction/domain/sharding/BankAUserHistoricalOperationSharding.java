...
public class BankAUserHistoricalOperationSharding extends AbstractDomainSharding {
...
//	private static final int OPERATION_TYPE_ID_COL_INDEX = 1;
	...
	private static final String TABLE_NAME = ActualResourceNameInterpreter
			.getTableName(BankAUserHistoricalOperation.class);
	private static final String USER_ID_COL_NAME = ActualResourceNameInterpreter
			.getColumnName(BankAUserHistoricalOperation.class, USER_ID_COL_INDEX);
//	private static final String OPERATION_TYPE_ID_COL_NAME = ActualResourceNameInterpreter
//			.getColumnName(BankAUserHistoricalOperation.class, OPERATION_TYPE_ID_COL_INDEX);
