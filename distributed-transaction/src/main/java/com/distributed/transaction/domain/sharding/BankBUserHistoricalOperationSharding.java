...
public class BankBUserHistoricalOperationSharding extends AbstractDomainSharding {

	private static final int TOTAL_TABLE_SHARDING_NUM = 2;
	private static final int USER_ID_COL_INDEX = 2;
//	private static final int OPERATION_TYPE_ID_COL_INDEX = 1;

	private static final String TABLE_NAME = ActualResourceNameInterpreter
			.getTableName(BankBUserHistoricalOperation.class);
	private static final String USER_ID_COL_NAME = ActualResourceNameInterpreter
			.getColumnName(BankBUserHistoricalOperation.class, USER_ID_COL_INDEX);
//	private static final String OPERATION_TYPE_ID_COL_NAME = ActualResourceNameInterpreter
//			.getColumnName(BankBUserHistoricalOperation.class, OPERATION_TYPE_ID_COL_INDEX);
	...
	protected TableShardingStrategy getTableShardingStrategy() {
		...
		return new TableShardingStrategy(USER_ID_COL_NAME,
				new TableSingleKeyShardingStrategyAlgorithmImpl(algorithm));
	}
