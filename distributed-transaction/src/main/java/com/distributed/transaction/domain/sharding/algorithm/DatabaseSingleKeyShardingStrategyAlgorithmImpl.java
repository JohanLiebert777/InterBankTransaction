...
public class DatabaseSingleKeyShardingStrategyAlgorithmImpl
		implements SingleKeyDatabaseShardingAlgorithm<Comparable<String>> {

	private ShardingAlgorithm algorithm;

	public DatabaseSingleKeyShardingStrategyAlgorithmImpl(ShardingAlgorithm algorithm) {
