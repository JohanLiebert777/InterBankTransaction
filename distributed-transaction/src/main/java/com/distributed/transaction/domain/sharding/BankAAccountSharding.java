...
public class BankAAccountSharding extends AbstractDomainSharding {
...
//	private static final int GEO_ID_COL_INDEX = 2;
	...
	private static final String TABLE_NAME = ActualResourceNameInterpreter.getTableName(BankAAccount.class);
	private static final String USER_ID_COL_NAME = ActualResourceNameInterpreter.getColumnName(BankAAccount.class,
			USER_ID_COL_INDEX);
//	private static final String GEO_ID_COL_NAME = ActualResourceNameInterpreter.getColumnName(BankAAccount.class,
//			GEO_ID_COL_INDEX);
